package com.poo.collections.listas;
...
DecimalFormat formatador = new DecimalFormat("R$ #,##0.00");
		...
		Cargo comissario = new Cargo();
		comissario.setDescricao("Comissário");
		comissario.setSalario(new BigDecimal(70000));
		...
		// adiciona comissario
		politico = new Politico();
		politico.setNome("Gustavo Silva");
		politico.setCargo(comissario);
		governo.adicionarPolitico("PSL", politico);
		...
		BigDecimal gastosPsl = governo.calcularGastosComSalario("PSL");
		System.out.println("Gastos com partido PSL: " + formatador.format(gastosPsl.doubleValue()));
		...
		BigDecimal gastosComissarioPsl = governo.calcularGastosComSalarioParaCargo(comissario, "PSL");
		System.out.println("Gastos com comissários do partido PSL: " 
			+ formatador.format(gastosComissarioPsl.doubleValue()));
	}
